...
<?php
    ...
    if(isset($_POST)){
        if(isset($_POST['idtourdate']) && isset($_POST['token'])){
            $token_qs= $_POST['token'];
            $id_qs=$_POST['idtourdate'];
            if($token_qs==$token){
                $deletetourdate= new TourDates();
                $deletetourdate->idtourdates=$id_qs;
                $_ADOTourDates = new ADOTourDates();
                $_ADOTourDates->DeleteTourDate($deletetourdate);
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<form id="deleteUser" method="post" action="deletetourdate.php">
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="2" style="text-align: center">
                    ...
                    <input type="hidden" name="idtourdate" value="<?php echo $idtourdate; ?>">
