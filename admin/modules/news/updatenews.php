...
if(!empty($_POST)){
    if(isset($_POST['title']) && isset($_POST['subtitle']) && isset($_POST['newsdate']) && isset($_POST['token']) && isset($_POST['active']) && isset($_POST['articule'])  && isset($_POST['idnews']) ){
        $token=$_POST['token'];
        if($token==$SessionUser->token){
            ...
            $newarticle->idnews=$_POST['idnews'];
            ...
            $_ADONews->UpdateNews($newarticle);
