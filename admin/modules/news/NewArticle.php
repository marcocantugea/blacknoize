...
<div>
    ...
    <div  style="width: 100%">
        ...
        <div style="margin: 15px;">
            ...
            <br/>
            <br/>
            <label >Sub Title:</label> <input type="text" value="" name="subtitle" style="width:  80%" />
            <br/>
            <br/>
            <label >Date:</label> <input type="text" value="" id="newsdate" name="newsdate" style="width:20%" />
            <br/>
            <br/>
            <div style="width: 100%;">
                <textarea id='myTextarea' name="articule">&lt;p&gt;Hello, World!&lt;/p&gt;</textarea>
            </div>
            <br/>
            <br/>
