...
<?php
    ...
    if(isset($_POST)){
        if(isset($_POST['idvideos']) && isset($_POST['token'])){
            $token_qs= $_POST['token'];
            $id_qs=$_POST['idvideos'];
            if($token_qs==$token){
                $Video = new VideoObj();
                $Video->idvideos=$id_qs;
                $_ADOVideos = new ADOVideos();
                $_ADOVideos->DeleteVideo($Video);
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<form id="deleteUser" method="post" action="deletevideo.php">
        ...
        <table style="width: 100%">
            <tr>
                <td colspan="2" style="text-align: center">
                    ...
                    <input type="hidden" name="idvideos" value="<?php echo $idvideos; ?>">
