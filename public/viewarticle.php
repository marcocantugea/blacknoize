...
<?php
    ...
    if(isset($_GET['q'])){
        ...
        if(is_numeric($iddecoded)){
            $Articles= new NewsObj();
            $Articles->idnews=$iddecoded;
            $_ADONews = new ADONews();
            $_ADONews->GetArticle($Articles);
            
            // Declare OG Facebook Meta Tags
            $_fgmetaog=  new ArrayList();
            $OGMeta= new OGMetaFacebookObj();
            $OGMeta->title="Black Noize | ".$Articles->title;
            $OGMeta->description=$Articles->subtitle;
            $OGMeta->url=$pathvideo."public/viewarticle.php?q=".$idencode;
    ...
    <div id="news-div-content">
        ...
        <div class="newheader-content">
            <div style="width: 100%; text-align: center">
                <div class="fb-share-button" data-href="http://www.blacknoize.com.mx/public/viewarticle.php?q=<?php echo $idencode ?>" data-layout="button" data-size="large" data-mobile-iframe="false"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.blacknoize.com.mx%2Fpublic%2Fviewarticle.php&amp;src=sdkpreparse">Share</a></div>
            </div>
            <?php echo base64_decode($Articles->articule);?>
        </div>
    </div>
</div>
